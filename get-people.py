...
def main():
    ...
    csv_writer.writerow([
        ...
        'agent_groups', 'restricted_agent', 'ticket_restriction', 'suspended', 'org_tags'
    ])
    ...
    for user in z.users:
        ...
        csv_writer.writerow([
            ...
            user.role, group_names, user.restricted_agent, user.ticket_restriction, user.suspended, org_tags
        ])
